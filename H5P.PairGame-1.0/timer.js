(function (PairGame, Timer) {
   ...
   */
  PairGame.Timer = function (element) {
    /** @alias H5P.PairGame.Timer# */
    var self = this;
  ...
  // Inheritance
  PairGame.Timer.prototype = Object.create(Timer.prototype);
  PairGame.Timer.prototype.constructor = PairGame.Timer;

})(H5P.PairGame, H5P.Timer);
